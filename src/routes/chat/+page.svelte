<script lang="ts">
    ...
    let roomId = '';
    let actor: 'participant_ai' | 'participant_human' = 'participant_ai';
    let connected = false;
    let mode: 'AI' | 'HUMAN' = 'AI';
  
    function join() {
      if (!roomId.trim()) return;
      ws = connectWS(roomId.trim(), actor);
